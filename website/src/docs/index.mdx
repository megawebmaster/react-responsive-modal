...
### Focus Trapped options

You can also set to trap focus within the modal, but decide where to put focus when opened. To do this use `focusTrapOptions` prop and set `focusOn` to a ref of an element you want to focus. In this example we focus on the modal root element.

<ExampleRendered name="focusTrappedOptions" />

```js file=../examples/FocusTrappedOptions.tsx
...
| **focusTrapOptions**    | `{ focusOn?: 'firstFocusableElement'                                                                                                                                                                                                   | 'modalRoot' }` | { focusOn: 'firstFocusableElement' }                                                                                                                                                                               | When the modal opens focus this element. |
