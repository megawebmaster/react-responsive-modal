...
var FocusTrap = function FocusTrap(_ref) {
  ...
  React.useEffect(function () {
    ...
    if (isBrowser && container != null && container.current) {
      ...
      if ((options == null ? void 0 : options.focusOn) === 'firstFocusableElement') {
      ...
      } else if ((options == null ? void 0 : options.focusOn) === 'modalRoot') {
        var _container$current;

        savePreviousFocus();
        container == null ? void 0 : (_container$current = container.current) == null ? void 0 : _container$current.focus();
      }
    }
  ...
  }, [container, options == null ? void 0 : options.focusOn]);
  return null;
};
...
var Modal = function Modal(_ref) {
  ...
  var open = _ref.open,
      ...
      _ref$focusTrapOptions = _ref.focusTrapOptions,
      focusTrapOptions = _ref$focusTrapOptions === void 0 ? {
    focusOn: 'firstFocusableElement'
  } : _ref$focusTrapOptions,
  ...
  var refDialog = React.useRef(null);
